...
@Autonomous (name="AutonomousBoardSide")
public class AutonomousBoardSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // With board side we may run into problems with colliding with teammates

        // moveForward(); to spike zone
        // rotateAndLocateGamePiece();
        // moveForward(); to board
        // leftStrafe(); move out of the way for teammates
    }
